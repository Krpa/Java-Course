...
public class QSortParallel2Test {
	...
	public void isSortedTest1() {
		...
		assertEquals("Za sortirani niz metoda mora vratiti true", true, QSortParallel2.isSorted(a));
	}
	
	@Test
	public void isSortedTest2() {
		int[] a = new int[] {-1, 0, 1, 2, -2};
		assertEquals("Za nesortirani niz metoda mora vratiti false", false, QSortParallel2.isSorted(a));
	}
	...
	public void sortTest() {
		...
		while(brPonavljanja >= 0) {
			...
			assertEquals("Nije uspijelo sortiranje", true, QSortParallel2.isSorted(data));
			brPonavljanja--;
		}
	}
}
